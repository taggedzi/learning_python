...
print("*" * 40, "\n", "Print a range from 0 to 5")
for i in range(0, 5):
    print("{}".format(i))

print("*" * 40, "\n", "Print the characters of a string one at a time, iterating through the string.")
number = "654,321.123"
for i in range(0, len(number)):
    print(number[i], end='')
    print("")

print("*" * 40, "\n", "Filter a string by looping through it and removing any non-numeric characters.")
clean_number = ''
for i in number:
    if i in "0123456789":
...
print("*" * 40, "\n", "Use a for loop and a range to print even numbers.")
for i in range(0, 10, 2):
    print(i)

print("*" * 40, "\n", "Use continue in a for loop to skip any entries that are not 'spam'.")
...
print("*" * 40, "\n", "Use break in a for loop stop the loop if it encounters 'spam'.")
breakfast = ['eggs', 'turkey', 'spam', 'pancakes']
for item in breakfast:
    if 'spam' is item:
        break
...
print("*" * 40, "\n", "Use nested for loops to show multiplication table.")
for i in range(1, 10):
    for j in range(1, 10):
        print("{:<4}".format(j * i), end=" ")
    print("\n")

print("*" * 40, "\n", "Demonstrate the use of an else statement.")
for i in range(1, 3):
    print(i)
else:
    print('Finished loop without breaking')

print("*" * 40, "\n", "Demonstrate the use of an else statement when a break is triggered.")
for i in range(1, 10):
    print(i)
    break
else:
...
print("*" * 40, "\n", "Demonstrate what is happening under the hood using 'next' and 'iter'.")
demo = [1, 2, 3, 4, 5]
iter_ = demo.__iter__()
i = 0
while i <= 4:
